...
### 练习1：概念理解
题目：简述DenseNet的核心思想及适用场景。
<details><summary>参考答案</summary>
DenseNet通过数据驱动学习输入到输出的映射，适用于深度学习中的模式识别、预测和决策等任务。
</details>

### 练习2：公式推导
题目：写出DenseNet的损失函数并推导梯度。
<details><summary>参考答案</summary>
...
### 思考题
1. DenseNet在什么情况下会失效？
2. 训练数据很少时，DenseNet还能有效工作吗？
3. 如何将DenseNet与其他方法结合？
