...
### 推荐资源
AlphaGo原始论文、GitHub实现、Coursera/Stanford课程
...
### 练习1：概念理解
题目：简述AlphaGo的核心思想及适用场景。
<details><summary>参考答案</summary>
AlphaGo通过数据驱动学习输入到输出的映射，适用于强化学习中的模式识别、预测和决策等任务。
</details>

### 练习2：公式推导
题目：写出AlphaGo的损失函数并推导梯度。
<details><summary>参考答案</summary>
